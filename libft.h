...
t_list	*ft_lstlast(t_list *lst); // Check ok / renvoie le dernier elements de la liste
void	ft_lstadd_back(t_list **lst, t_list *new); // Check ok / ajoute element new a la fin de la liste
